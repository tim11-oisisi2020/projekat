...
public class TabeleSearchActions {
	
	private JTextField searchField;
	private JComboBox<String> searchableColumnsCb;
	private TableRowSorter<TableModel> sorter;
	
	public TabeleSearchActions(JTextField searchField, JComboBox<String> searchableColumnsCb, TableRowSorter<TableModel> sorter) {
